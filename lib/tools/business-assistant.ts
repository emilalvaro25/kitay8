...
export const businessAssistantTools: FunctionCall[] = [
  ...
  },
  {
    ...
    scheduling: FunctionResponseScheduling.INTERRUPT,
    icon: 'mail',
    postWebhookUrl: 'https://n8n.srv909561.hstgr.cloud/webhook/send-gmail-message',
    getStatusWebhookUrl: '',
  },
  {
    ...
    parameters: {
      type: 'OBJECT',
      properties: {
        recipient: { type: 'STRING', description: 'The name or phone number of the WhatsApp contact.' },
