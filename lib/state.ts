...
export const useUI = create<{
  ...
  toolConfirmationCallback: ((confirmed: boolean) => void) | null;
  requestToolConfirmation: (toolCall: any, callback: (confirmed: boolean) => void) => void;
  ...
  requestToolConfirmation: (toolCall, callback) => set({
    pendingToolCall: toolCall,
    toolConfirmationCallback: callback,
  }),
  clearToolConfirmation: () => set({
    pendingToolCall: null,
    toolConfirmationCallback: null,
  }),
